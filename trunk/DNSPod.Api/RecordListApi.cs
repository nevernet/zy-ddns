...
{
    public class RecordListApi: DNSPodApi
    {

        public List<RecordListItem> DomainList { get; set; }
        ...
        public override string ParseXML()
        {
            ...
            XmlNodeList nodes = doc.SelectNodes("//records/item");

            DomainList = new List<RecordListItem>();

            foreach (XmlNode node in nodes)
            {
                RecordListItem dlitem = new RecordListItem();
